<template>
  <span
    ...
    class="pointer text-md text-white font-bold text-center"
  ...
  <div v-show="isVisible" class="w-full mt-5">
    ...
    <p class="text-sm text-white px-5">Sunrise: {{ sunrise }}h</p>
    <p class="text-sm text-white px-5">Sunset: {{ sunset }}h</p>
  </div>
</template>
